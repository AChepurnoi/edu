...
object Anagrams {
  ...
  /** Converts the word into its character occurrence list.
    ...
    */
  def wordOccurrences(w: Word): Occurrences = w.toLowerCase.groupBy(o => o).mapValues(o => o.length).toList.sortWith(_._1 < _._1)

  /** Converts a sentence into its character occurrence list. */
  def sentenceOccurrences(s: Sentence): Occurrences = wordOccurrences(s flatMap (o => o.toList) mkString)
  ...
  def subtract(x: Occurrences, y: Occurrences): Occurrences =
    x.map(pair => if (y.exists(_._1 == pair._1)) (pair._1, pair._2 - y.find(_._1 == pair._1).get._2) else pair).filter(pair => pair._2 != 0)
